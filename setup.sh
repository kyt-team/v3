...
echo -e "\033[33m# // Author: ALVI TUNNEL\e[0m"
echo -e "\033[33m# // Description: Xray Menu Management\e[0m"
echo -e "\033[33m# // email: admin@Alvi.com\e[0m"
echo -e "\033[33m# // telegram: t.me/Alvi_cell\e[0m"
echo -e "\033[33m# //====================================\e[0m"
sleep 1
Green="\e[92;1m"
RED="\033[31m"
...
TIME="10"
CHATID="1156078455"
KEY="6593069504:AAEiB6XCRwxlnxPujmw0TzbUi7HO6mCnNec"
...
LOGO() {
    ...
    echo -e " ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───"
    echo -e " ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───"
    echo -e "    │    ${YELLOW}Copyright${FONT} (C)${GRAY}https://t.me/Alvi_cell$NC   │"
    echo -e "    └───────────────────────────────────────────────┘"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/kyt-team/regip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/kyt-team/regip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
# Status ExpiRED Active | Alvi Project
Info="(${green}Active${NC})"
Error="(${RED}ExpiRED${NC})"
today=`date -d "0 days" +"%Y-%m-%d"`
Exp1=$(curl https://raw.githubusercontent.com/kyt-team/regip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/kyt-team/v3/main/"
...
function notif_bot() {
    USRSC=$(curl https://raw.githubusercontent.com/kyt-team/regip/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/kyt-team/regip/main/ip | grep $ipsaya | awk '{print $3}')
...
<i>Github kyt-team</i> 
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/Alvi_cell"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/Alvi_cell"}]]}'
